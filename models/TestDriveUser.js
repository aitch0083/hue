...
var TestDriveUser = sequelize.define('test_drives_users', {
    ...
    test_drive_id: { type: SZ.BIGINT(20).UNSIGNED, allowNull: false },
...
TestDriveUser.show_fields = [//follow jsGrid's definition
